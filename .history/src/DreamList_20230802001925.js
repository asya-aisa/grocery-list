        ...
        return <div>
            ...
            <ul>
                {this.state.dreamList.map((item, index) => (
                    <li className={this.state.isDone ? 'done-dream done-dream::before' : 'item'} key={index}>
                        {item}
                        <div className="btn-div">
                          <button onClick={() => {this.setState({isDone: !this.state.isDone})}} className="btn">Done</button>
